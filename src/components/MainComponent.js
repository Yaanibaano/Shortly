    ...
    render() {
        return (
            <div className="container">
                <div className="row bg-red justify-lg-content-center justify-content-between">
                    <div className="col-2 row justify-content-center bg-green text-center ml-5 ml-lg-0 ml-sm-3">
